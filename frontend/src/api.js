...
export const api = {
  ...
  getCurrentSettings: () => request('GET', '/bubble-community/api/bubbles/current-settings'),
  saveCurrentSettings: (data) => request('PUT', '/bubble-community/api/bubbles/current-settings', data),
